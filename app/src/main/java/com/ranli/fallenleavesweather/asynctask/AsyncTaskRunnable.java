package com.ranli.fallenleavesweather.asynctask;
...
public class AsyncTaskRunnable implements Runnable{
    ...
    public AsyncTaskRunnable(Context context) {
        ...
        mNotification.icon = R.drawable.app_icon;//设置下载进度的icon
        ...
        mRemoteViews.setImageViewResource(R.id.id_download_icon, R.drawable.app_icon);
    }
    ...
    public void run() {//通过判断不同的状态：更新中/下载失败/下载成功 更新下拉菜单的通知信息
        switch (mStatus) {
            ...
            case AsyncTaskUtil.NOTIFICATION_PROGRESS_UPDATE://更新中
                ...
                mRemoteViews.setTextViewText(R.id.id_download_textview, "下载进度: " + progress + " %");
